...
if(isset($_POST["actualizar_tipo_producto"])){
    ...
    if($valido==2){
        $mensaje=$consultas->actualizar_tipo_producto($codigo,$desc,$precio,$estado);
                                                    ...
                                                    <form class="user" name="Insertar_Tipo_producto" action="" method="post">
                                                        <div class="form-group row">
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                <input type="text" class="form-control form-control-user" value="<?php echo $info['cod_producto']; ?>" name="codigo_producto" id="codigo_producto"
                                                                value="<?= (isset($codigo) && !$frm_enviado)?$codigo : "" ?>" readonly="disabled" >
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                <input type="text" class="form-control form-control-user" value="<?php echo $info['desc_producto']; ?>" name="desc_producto" id="desc_producto" placeholder="Descripción"
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                <input type="text" class="form-control form-control-user" value="<?php echo $info['precio']; ?>" name="precio_producto" id="precio_producto"
                                                                value="<?= (isset($precio) && !$frm_enviado)?$precio : "" ?>">
                                                            </div>
                                                        </div>
